         ...
         <div className="about__content">
            ...
            <div className="about__content--contact">
               ...
               <div className="about__content--contact-list">
                  ...
                  <a href="https://drive.google.com/file/d/1jh1BzpkLEnHk6-ExnIr-mG2GmHk5FXgS/view?usp=sharing" className="about__content--contact-list-item" target="_blank" rel="noreferrer"><img src={cv} alt="" /></a>
               </div>
