...
import morse from "../assets/images/morse-translator.png";
...
const projects = [
  ...
  },
  {
    name: "Punk API",
    description:
      "A small web app to browse and search the products of Brewdog, using the data from 'https://punkapi.com/'",
    technology: ["React"],
